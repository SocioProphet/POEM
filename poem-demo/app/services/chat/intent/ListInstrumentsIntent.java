...
public record ListInstrumentsIntent(List<String> collectionUris,
    ...
    public String toSparql() {
        ...
        query.append("  OPTIONAL {\n")
             ...
             .append("    ?language rdfs:label ?languageLabelLiteral .\n")
             .append("    ?language skos:notation ?languageNotationLiteral .\n")
             .append("    BIND(\n")
             .append("        CONCAT(\n")
             .append("            STR(?languageLabelLiteral),\n")
             .append("            \" [\",\n")
             .append("            STR(?languageNotationLiteral),\n")
             .append("            \"]\"\n")
